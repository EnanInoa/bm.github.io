...
<body>
 ...
 <label for="checkbox-menu" class="icono-menu"><img src="../iconos/menu.svg" alt=""></label>
  ...
  <main>
    ...
    <form  action="procesarAgregarEstudiante.php" method="get">

    <div class= "contenedor-agregar">
      <h2 class="form_titulo">Agregar Estudiante</h2>
...
<input type="submit" name="Agregar" class="btnes" value="Agregar">
